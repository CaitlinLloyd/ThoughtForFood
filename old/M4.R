...
# This version fits 3-factor model with umami delay relative to health and taste
...
write.csv(subs,"results/Sept_delayumami_sublist.csv")
...
write.csv(s,"results/Sept_delayumami_cross_validated_folds.csv")
